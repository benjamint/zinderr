...
import { X, MapPin, DollarSign, Calendar, Camera, FileText, Upload, Image as ImageIcon } from 'lucide-react'
import { supabase, ERRAND_CATEGORIES, CATEGORY_ICONS, CATEGORY_COLORS } from '../../lib/supabase'
...
export function PostErrandModal({ onClose, onSuccess }: PostErrandModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Error posting errand. Please try again.')
    } finally {
      setLoading(false)
    }
  }
